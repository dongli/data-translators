module profiler_mod
  ...
  type, extends(obs_static_record_base_type) :: profiler_decode_record_type
    type(profiler_station_type), pointer :: station
  ...
  contains
    procedure :: init => profiler_decode_record_init
  end type profiler_decode_record_type
...
contains
  ...
  subroutine profiler_decode_record_init(this)

    class(profiler_decode_record_type), intent(out) :: this
  ...
  end subroutine profiler_decode_record_init
