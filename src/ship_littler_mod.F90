  ...
  subroutine ship_littler_write(file_path)
    ...
    do while (.not. record_iterator%ended())
      ...
      type is (ship_record_type)
        ...
        write(10, '(A40)',   advance='no') record%ship%name                   ! id
        write(10, '(A40)',   advance='no') record%ship%name                   ! name
        write(10, '(A40)',   advance='no') 'FM-13'                            ! platform
        ...
        write(10, '(F13.5)', advance='no') record%ship_wind_speed             ! wind speed (m s^-1)
