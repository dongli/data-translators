  ...
  subroutine ship_littler_write(file_path, ships, records)
    ...
    do while (.not. record_iterator%ended())
      ...
      type is (ship_record_type)
        ...
        write(10, *)
        ! Record
        write(10, '(F13.5)', advance='no') littler_value(record%ship_pressure)                  ! pressure (Pa)
        ...
        write(10, '(F13.5)', advance='no') littler_value(record%ship_wind_speed)                ! wind speed (m s^-1)
        write(10, '(I7)',    advance='no') 0                                                    ! wind QC
        write(10, '(F13.5)', advance='no') littler_value(record%ship_wind_direction)            ! wind direction (degree)
        write(10, '(I7)',    advance='no') 0                                                    ! wind QC
        write(10, '(F13.5)', advance='no') littler_value(record%ship_wind_u)                    ! wind u component (m s^-1)
        write(10, '(I7)',    advance='no') 0                                                    ! wind u component QC
        write(10, '(F13.5)', advance='no') littler_value(record%ship_wind_v)                    ! wind v component (m s^-1)
        write(10, '(I7)',    advance='no') 0                                                    ! wind v component QC
        write(10, '(F13.5)', advance='no') littler_value(record%ship_relative_humidity)         ! relative humidity (%)
