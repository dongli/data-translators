...
contains
  ...
  subroutine anem_nrg_txt_read(file_path, towers, records)
    ...
    do while (.true.)
      ...
      print *, time%isoformat(), record%ta_avg
      call records%insert(tower_id // '@' // time%isoformat(), record)
